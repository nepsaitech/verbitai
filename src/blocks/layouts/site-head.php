<?php
    $header_class = $header_bg_color = $header_style_1 = $header_style_2 = $header_style_3 = $header_style_4 = $complete_segment_logo_url = $complete_segment_logo_alt = "";
    
    if ( is_page_template('page-transcript.php') ) {  // Sample and Question page
        ...
        $header_style_1 .= "bg-white fixed w-full max-w-full px-[39px] z-50 max-sm:p-[11px] max-md:px-5";
        ...
        $header_bg_color = "";
        $header_style_1 = "fixed w-full max-w-full px-[39px] py-[33px] z-50 max-lg:px-[9px] max-lg:py-[11px]";
        $header_style_2 = "flex justify-between items-center rounded-[100px] py-4 pl-[38px] pr-[23px] max-lg:p-4";
        $header_style_3 = "mr-8 max-sm:flex max-sm:items-center logo";
        $header_style_4 = "w-[126px] h-[43px] leading-[0] max-sm:w-[95px] max-sm:h-[33px]";
...
<header class="<?php echo esc_attr( $header_bg_color ); ?><?php echo esc_attr( $header_class ); ?>">
        ...
        <section class="<?php echo esc_attr( $header_style_2 ); ?>">
            ...
            <div class="flex items-center max-[860px]:flex-[1_0_auto] max-[860px]:justify-end" data-section="menu">
                ...
                <script>
                    ...
                    var siteLogo = {
                        url_1: "<?php echo esc_url( $logo_variation_1_url ); ?>",
