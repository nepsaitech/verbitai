...
if ( have_rows( 'sidebar' ) ):
    ...
    ?>
        ...
        <sidebar class="flex-[1_0_auto] max-w-[362px] w-full max-[1320px]:max-w-[27%] max-[1050px]:hidden">
            <div class="sidebar">
                <div class="relative w-full bg-white rounded-[20px] [box-shadow:0px_7.84px_8.96px_0px_#5148F91A] py-[5px] px-[7px] mb-[14px] max-[1050px]:max-w-[362px] max-[1050px]:mb-[28px] max-[1050px]:mx-auto js-video">
                ...
                if ( have_rows( 'cta' ) ):
                    while ( have_rows( 'cta' ) ) : the_row();
                        ...
                        <div class="flex flex-wrap justify-center items-center max-md:flex-col bg-primary text-white py-[29.6px] px-[30px] rounded-[20px] gap-[37px] max-md:text-center js-transcript">
                            <h2 class="text-xl leading-[21px] font-bold"><?php echo esc_html( $title ); ?></h2>
                            ...
                            if ( $link ) :
                                ...
                                <a href="#" class="!text-white text-lg leading-[38px] px-[18px] rounded-[56px] font-bold border-2 border-solid border-white text-center" data-target="purchase"><?php echo esc_html( $link_title ); ?></a>
