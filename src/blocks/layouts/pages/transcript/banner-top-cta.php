    ...
    <div class="bg-[#F6F6FF] min-h-[470px] max-[999px]:bg-transparent max-[999px]:min-h-0">
        <div class="max-w-[1315px] mx-auto">
            <div class="pt-[107px] max-sm:px-0 max-[1320px]:px-5">
                ...
                <?php
                // This is a placeholder value. Replace it with the actual duration of the current transcript.
                $current_transcript_duration = 33;
                if ( have_rows( 'content' ) ):
                    while ( have_rows( 'content' ) ) : the_row();
                        $field_group = $current_transcript_duration < 30
                        ? 'transcription_shorter_than_30_mins' 
                        : 'transcription_longer_than_30_mins';
