    ...
    <div class="max-w-[906px] mx-auto max-lg:max-w-full">
        <div class="relative max-md:mt-0">
            ...
            if ( have_rows( 'content' ) ):
                ...
                <div class="flex justify-around space-x-7 items-center mt-[69px] max-md:mt-[60px] max-md:space-x-0 max-md:gap-10 max-md:justify-center">
                    ...
                    if ( have_rows( 'g2_rating_and_reviews' ) ):
                        ...
                        ?>
                            ...
                            <div class="flex items-center gap-[5px] max-md:flex-col max-md:gap-0 max-md:justify-center max-md:text-center">
                                ...
                                <span class="uppercase text-xs font-[500] leading-[32px] max-md:order-3"><?php echo esc_html( $g2_label ); ?></span>
                    ...
                    if ( have_rows( 'hours_transcribed_yearly' ) ):
                        ...
                        <div class="flex items-center gap-[5px] max-md:flex-col max-md:gap-0 max-md:justify-center max-md:text-center">
                            ...
                            <span class="uppercase text-xs font-normal leading-[32px] max-md:leading-[26px]"><span class="text-primary font-bold max-md:block"><?php echo esc_html( $hours_transcribed_total ); ?> Hours</span>  <?php echo esc_html( $hours_transcribed_label ); ?></span>
