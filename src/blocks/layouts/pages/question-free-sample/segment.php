    ...
    <div class="max-[880px]:bg-primary max-[880px]:py-[21px] max-[880px]:px-3 max-[880px]:w-full">
        <div class="text-center max-[880px]:bg-white max-[880px]:rounded-[40px] pt-[26px] px-2.5 pb-[25px]">
            ...
            <div>
                ...
                <a href="/self-service/sample" id="sample-ready-btn" class="flex-[1_0_auto] bg-primary !text-white leading-[51px] text-center text-[17px] py-[5.5px] px-2 rounded-[56px] font-bold max-w-[142px] w-full">Continue</a>
            </div>
        </div>
    </div>
';
