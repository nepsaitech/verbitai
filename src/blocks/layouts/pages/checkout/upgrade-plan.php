<section class="checkout">
    <div class="mx-auto">
        <div class="flex max-md:flex-col max-md:px-2.5">
            <div class="flex flex-col flex-grow pt-[122px] pb-[68px] pl-[138px] pr-[60px] max-md:pb-0 max-md:px-0 max-lg:px-5">
                
                <?php 
                if ( have_rows( 'upgrade_plan_left_side' ) ) :
                    while ( have_rows( 'upgrade_plan_left_side' ) ) : the_row();
                                ...
                                if ( have_rows( 'hour_subscription' ) ) :
                                    while ( have_rows( 'hour_subscription' ) ) : the_row();
                                        ...
                                        <div class="flex flex-col gap-y-2 mb-[18px]">
                                            ...
                                            <p class="text-sm -tracking-[0.38px] leading-[14px] text-[#041D3480] py-2"><?php echo esc_html( $balance ); ?> <strong>5 hours</strong></p>
                                        ...
                                        <!-- <div class="relative w-fit">
                                            <select name="plan-package" id="hourly-plan" data-plan="1338" class="text-primary border-[1.33px] border-[#5148F933] rounded-[1.33px] relative py-[7px] px-[11px] pr-8 -tracking-[0.17px] leading-[23px]">
            ...
            <div class="bg-[#F6F6FF] h-screen max-w-[517px] w-full pt-[130px] pl-[64px] max-md:py-5 max-md:px-[25px] max-lg:px-5 max-md:rounded-[20px] max-md:max-w-full max-md:mt-[14px] max-md:min-h-0 max-md:h-auto" data-checkout="free-trial">
                <div class="flex flex-col max-w-[389px] w-full gap-3">
                    <div class="flex flex-wrap items-center gap-[13px] border-b border-[#041D34] border-opacity-[10%] pb-3">
                        <h2 class="font-bold text-[#041D34] text-[22px] leading-[34px] -tracking-[0.38px]">Enjoy our Business Subscription</h2>
                    </div>
                        ...
                        /* if ( have_rows( 'list' ) ):
                            while ( have_rows( 'list' ) ) : the_row();
                                ...
                                <li class="relative py-[7px] pl-[21px] text-[#041D34A6]   leading-[130%] -tracking-[0.17px] max-md:leading-6 max-md:pl-[19px]">
                                    ...
                                    Ability to transcribe, caption & translate
                                </li>
