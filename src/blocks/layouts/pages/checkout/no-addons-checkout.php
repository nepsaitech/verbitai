        ...
        <div class="flex max-md:flex-col max-md:px-2.5">
            <div class="flex flex-col flex-grow pt-[122px] pb-[44px] pl-[138px] pr-[60px] max-md:pb-0 max-md:px-0 max-lg:px-5">
                <div class="max-w-[786px] w-full flex flex-col max-md:gap-0 max-md:max-w-full">
                    <div class="mb-[14px]">
                        <h2 class="font-extrabold text-[40px] leading-[100%] max-md:text-center max-md:mb-[36px]">Personalize your order</h2>
                    </div>
                    <div class="border border-[#EFEFEF] rounded-[20px] py-[24px] px-[30px] mb-[14px]">
                        <div class="border-b border-[#EFEFEF] pb-[27px] mb-[15px]">
                            <h2 class="font-bold text-[#041D34] text-[22px] leading-[100%] -tracking-[0.38px] mb-2.5">Human Review</h2>
                            <p class="font-bold text-[#041D34A6] leading-[23px] -tracking-[0.17px] mb-3">Enhance your accuracy with our expert transcribers reviewing your order. Select the speed that suits your needs:</p>
                            <ul class="flex flex-col gap-2 text-[#041D34A6] list-disc list-outside pl-[19px]">
                                <li class="leading-[100%] -tracking-[0.17px] text-[19px]">Standard (up to 96 hours) – perfect for non-urgent tasks</li>
                                <li class="leading-[100%] -tracking-[0.17px] text-[19px]">Fast (up to 24 hours) – ideal for time-sensitive projects</li>
                            </ul>
                        </div>
                    ...
                    <div class="flex gap-[14px] mb-[38px]">
                        <a href="#" class="flex flex-col flex-grow justify-center border border-[#EFEFEF] rounded-[20px] min-h-[101px] px-[30px] py-2.5" data-target="translation">
                            <p class="text-primary">+ Translation Settings (Optional)</p>
                            <span class="text-[#041D34A6]">Choose your languages for translation.</span>
                        </a>
                        <a href="#" class="flex flex-col flex-grow justify-center border border-[#EFEFEF] rounded-[20px] min-h-[101px] px-[30px] py-2.5" data-target="keywords">
                            <p class="text-primary">+ Add Keywords (Optional)</p>
                            <span class="text-[#041D34A6]">Use specific terms for accuracy. (e.g., date, name)</span>
                        </a>
                    </div>
                    <div class="max-md:fixed max-md:bg-white max-md:py-[21px] max-md:px-[17px] max-md:inset-x-0 max-md:bottom-0 max-md:[box-shadow:0px_-1px_14px_0px_#0000001A] max-md:backdrop-filter backdrop-blur-[10px] max-md:z-10 max-md:justify-center max-md:gap-0">
                        <a href="#" class="inline-block bg-primary !text-white text-center text-[17px] leading-[52px] py-[5px] px-2.5 min-w-[234px] w-fit rounded-[56px] font-bold max-md:min-w-0 max-md:px-[26px]">Continue</a>
                    </div>
                </div>   
            </div>
