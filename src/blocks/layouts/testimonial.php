<div class="testimonial">
    <div class="">
        ...
        $total_posts = $testimonials->found_posts;
        $center_posts = ($total_posts === 3) ? false : true;

        if ($testimonials->have_posts()) : ?>

            <div class="testimonial-slider min-h-[570px] max-w-[1438px] mx-auto max-md:pb-0 max-md:min-h-[423px]" data-total="<?php echo $total_posts; ?>">
