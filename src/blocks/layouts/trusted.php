<section class="trusted">
    <div class="max-w-screen-xl mx-auto">
        <div class="pt-[117px] px-5 text-base text-primary text-center max-md:pt-[60px] max-md:px-3">

            <?php
            if ( have_rows( 'trusted_companies', 'option' ) ) :
                while( have_rows( 'trusted_companies', 'option' ) ) :
                the_row();
                ...
                ?>
                    ...
                    <h2 class="text-[22px] leading-[65px] font-extrabold mb-[34px]"><?php echo esc_html( $heading ); ?></h2>
