<section class="fixed bg-[#00000080] inset-0 hidden justify-center items-center px-[22px] z-[60] purchase" data-type="modal" data-modal="translate">
    <div>
        <div class="relative bg-white max-w-[760px] w-full flex items-stretch rounded-[20px] [box-shadow:0px_4px_14px_0px_#0000001A] text-[#041D34A6] overflow-hidden max-md:flex-col" data-info="content">
            <a href="#" class="inline-block absolute left-[21px] top-5 max-md:top-[18px]" data-close="translate">
