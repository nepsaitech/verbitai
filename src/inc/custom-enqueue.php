...
function enqueue_custom_script() {
    ...
    if ( file_exists( $manifest_path ) ) {
		...
		if ( isset( $manifest[ 'main.js' ] ) )  {
			...
			wp_localize_script('main', 'stripeConfig', array(
		...
		// Buy more confirmation page
		if ( is_page( 1899  )  && isset( $manifest[ 'buy-more-confirmation.js' ] ) )  {
            wp_enqueue_script('buy-more-confirmation', get_template_directory_uri() . $manifest[ 'buy-more-confirmation.js' ], array(), null, true);
        }
	}
