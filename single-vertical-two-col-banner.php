<?php
/*
Template Name: Vertical with Two Column Banner
Template Post Type: vertical
*/
...
if ( have_rows( 'vertical_blocks' ) ) {
    while ( have_rows( 'vertical_blocks' ) ) {
        ...
        if ('two-col-banner' === get_row_layout() || 'smart-video' === get_row_layout() || 'what-you-get' === get_row_layout() || 'static-featured-section' === get_row_layout()) {
